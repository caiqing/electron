...
Object.defineProperty(WebContents, 'audioMuted', {
  get: () => WebContents.prototype.isAudioMuted(),
  set: (muted) => WebContents.prototype.setAudioMuted(muted)
})

Object.defineProperty(WebContents, 'userAgent', {
  get: () => WebContents.prototype.getUserAgent(),
  set: (agent) => WebContents.prototype.setUserAgent(agent)
})

Object.defineProperty(WebContents, 'zoomLevel', {
  get: () => WebContents.prototype.getZoomLevel(),
  set: (level) => WebContents.prototype.setZoomLevel(level)
})

Object.defineProperty(WebContents, 'zoomFactor', {
  get: () => WebContents.prototype.getZoomFactor(),
  set: (factor) => WebContents.prototype.setZoomFactor(factor)
})

Object.defineProperty(WebContents, 'frameRate', {
  get: () => WebContents.prototype.getFrameRate(),
  set: (rate) => WebContents.prototype.setFrameRate(rate)
})
